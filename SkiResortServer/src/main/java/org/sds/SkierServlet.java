...
public class SkierServlet extends HttpServlet {
    ...
    private final static String QUEUE_URL = "172.31.18.111";

    // TODO: change REDIS_HOST
    private final static String REDIS_HOST = "172.31.11.46";
...
//          send message to rabbitmq queue.
    ...
    // urlParts = [, 1, seasons, 2019, day, 1, skier, 123]
    private void formatGet2(String urlPath) {
        String[] urlParams = urlPath.split("/");
        this.resortID = urlParams[1];
        this.seasonID = urlParams[3];
        this.dayID = urlParams[5];
        this.skierID = urlParams[7];
    }

    // urlParts = [, 1, vertical]
    private void formatGet3(String urlPath) {
        String[] urlParams = urlPath.split("/");
        this.skierID = urlParams[1];
    }
